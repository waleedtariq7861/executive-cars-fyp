        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1.1fr_.9fr] gap-8">
          <section className="bg-white border border-gray-200 rounded-2xl p-8 shadow-sm">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-xl p-5 mt-6">
              ...
              <div className="flex items-center justify-between mt-3"><span className="text-gray-700 font-semibold">Reference plan value</span><span className="text-blue-600 font-black text-2xl">{AUCTION_MEMBERSHIP_PRICE_LABEL}</span></div>
          ...
          <section className="bg-white border border-gray-200 rounded-2xl p-8 shadow-sm flex flex-col justify-center">
            ...
            <span className="inline-flex w-fit rounded-full bg-amber-50 border border-amber-200 px-3 py-1 text-xs font-black uppercase tracking-wide text-amber-800">Demonstration Mode</span>
            <h2 className="text-xl font-black text-gray-900 mt-4">Simulate Membership Activation</h2>
            ...
            <button type="button" onClick={activateDemoMembership} disabled={loading} className="btn-primary w-full py-4 text-sm gap-2 mt-6 disabled:opacity-60">
